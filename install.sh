...
echo "  • AGENTS.md                 - Codex repository guidance"
echo "  • CLAUDE.md                 - Claude compatibility guidance"
echo ""
info "Tooling (committed to git):"
echo "  • .agents/ + .codex/        - Codex skills and custom agents"
echo "  • .claude/commands/loom/*.md - Canonical workflows and Claude compatibility"
